/*
 * Tetra Tech
 *  this has been modified so that it includes the scale formatted like Scale 1:5,000,000
 *  
 *  The modification is in the onExtentChange() function
 * 
    ...
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      */
      ...
      onExtentChange: function(evt) {
        ...
        // added by Tetra Tech to include scale in the coordinates (Scale 1:5,000,000) for example
		var scale = esri.geometry.getScale(this.map);//jab
		var myNumber = dojoNumber.format(scale, {//jab
			places: 0});//jab
		htmlSet.set(this.scaleInfo, "Scale: 1 : " + myNumber);//jab
        // end added section
